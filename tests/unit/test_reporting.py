...
def test_generate_monthly_report(sample_daily_results, sample_portfolio, sample_betas, tmp_path):
    """Test PDF report generation."""
    # Set up test output path
    output_path = os.path.join(tmp_path, "test_report.pdf")

    # Generate report
    generate_monthly_report(sample_daily_results, sample_portfolio, sample_betas, output_path)
